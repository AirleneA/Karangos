...
import logoCarros  from '../vintage-cars.png'
...
export default function Homepage() {
    ...
    const [visible, setVisibible] = useState(false)   // Transforme isto em uma variável de estado
        ...
        <> 
            ...
            <p className={classes.paragBotao}>
                <Button
                    variant="contained"
                    color="secundary"
                    onClick={() => (setVisibible(!visible))}
                >
                    Surpresa!
                </Button>
            </p>

            <img src={logoCarros} className={classes.logo} alt="Carros antigos" style={{height: visible ?'591px': '0', opacity: visible ? '1' : '0'}} />
        </>
    )
}